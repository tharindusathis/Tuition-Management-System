  ...
  export default {
      ...
      return {
        ...
        fields: [
         ...
         { key: 'date', label: 'Date' , sortable: true },
          ...
          { key: 'timeslot_minutes', label: 'Duration(min)' , sortable: true },

          { key: 'hourly_rate', label: 'Hourly Rate(Rs/h)' , sortable: true },

         { key: 'amount', label: 'Total Amount(Rs)' , sortable: true },
         { key: 'institute_rate', label: 'Institute Rate(%)' , sortable: true },
         
         { key: 'commission', label: 'Institute Commission' , sortable: true },
    ...
    methods: {
        getRows(id){
            ...
            let url = "http://localhost:8000/api/teacher_unpayed/" + id;
        axios.get(url)
            .then(response => {
