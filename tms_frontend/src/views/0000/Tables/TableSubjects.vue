  ...
  export default {
    data() {
      return {
        ...
        fields: [
          { key: 'idsubject', label: 'ID', sortable: true },
          { key: 'subject_name', label: 'Name', sortable: true },
          { key: 'grade', label: 'Grade', sortable: true },
          { key: 'medium', label: 'Lang', sortable: true },
          { key: 'syllabus_year', label: 'Syllabus', sortable: true},
          { key: 'class_count', label: 'Class Count', sortable: true},
          { key: 'avg_rate', label: 'Avg Rate(Rs/h)', sortable: true }
        ],
        currentPage: 1,
        perPage: 50,
        //totalRows: totalRows(),
    ...
    mounted(){
      const axios = require('axios'); this.isBusy = true;
        axios.get("http://localhost:8000/api/all_subject")
            .then(response => {
